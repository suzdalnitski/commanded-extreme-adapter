defmodule ElixirUUID do
  ...
  * `"urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"`
  ...
  ```elixir
  iex> ElixirUUID.info("870df8e8-3107-4487-8316-81e089b8c2cf")
  ...
  iex> ElixirUUID.info("8ea1513df8a14dea9bea6b8f4b5b6e73")
  ...
  iex> ElixirUUID.info("urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304")
  ...
  iex> ElixirUUID.info(<<39, 73, 196, 181, 29, 90, 74, 96, 157, 47, 171, 144, 84, 164, 155, 52>>)
  ...
  * `"urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"`
  ...
  ```elixir
  iex> ElixirUUID.binary_to_string!(<<135, 13, 248, 232, 49, 7, 68, 135,
  ...>        131, 22, 129, 224, 137, 184, 194, 207>>)
  "870df8e8-3107-4487-8316-81e089b8c2cf"

  iex> ElixirUUID.binary_to_string!(<<142, 161, 81, 61, 248, 161, 77, 234, 155,
  ...>        234, 107, 143, 75, 91, 110, 115>>, :hex)
  "8ea1513df8a14dea9bea6b8f4b5b6e73"

  iex> ElixirUUID.binary_to_string!(<<239, 27, 26, 40, 238, 52, 17, 227, 136,
  ...>        19, 20, 16, 159, 241, 163, 4>>, :urn)
  "urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"

  iex> ElixirUUID.binary_to_string!(<<39, 73, 196, 181, 29, 90, 74, 96, 157,
  ...
  * `"urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304"`
  ...
  ```elixir
  iex> ElixirUUID.string_to_binary!("870df8e8-3107-4487-8316-81e089b8c2cf")
  <<135, 13, 248, 232, 49, 7, 68, 135, 131, 22, 129, 224, 137, 184, 194, 207>>

  iex> ElixirUUID.string_to_binary!("8ea1513df8a14dea9bea6b8f4b5b6e73")
  <<142, 161, 81, 61, 248, 161, 77, 234, 155, 234, 107, 143, 75, 91, 110, 115>>

  iex> ElixirUUID.string_to_binary!("urn:uuid:ef1b1a28-ee34-11e3-8813-14109ff1a304")
  <<239, 27, 26, 40, 238, 52, 17, 227, 136, 19, 20, 16, 159, 241, 163, 4>>

  iex> ElixirUUID.string_to_binary!(<<39, 73, 196, 181, 29, 90, 74, 96, 157, 47,
  ...
  ```elixir
  iex> ElixirUUID.uuid3(:dns, "my.domain.com")
  "03bf0706-b7e9-33b8-aee5-c6142a816478"

  iex> ElixirUUID.uuid3(:dns, "my.domain.com", :default)
  "03bf0706-b7e9-33b8-aee5-c6142a816478"

  iex> ElixirUUID.uuid3(:dns, "my.domain.com", :hex)
  "03bf0706b7e933b8aee5c6142a816478"

  iex> ElixirUUID.uuid3(:dns, "my.domain.com", :urn)
  "urn:uuid:03bf0706-b7e9-33b8-aee5-c6142a816478"

  iex> ElixirUUID.uuid3(:dns, "my.domain.com", :raw)
  <<3, 191, 7, 6, 183, 233, 51, 184, 174, 229, 198, 20, 42, 129, 100, 120>>

  iex> ElixirUUID.uuid3("cdfdaf44-ee35-11e3-846b-14109ff1a304", "my.domain.com")
  "8808f33a-3e11-3708-919e-15fba88908db"

  iex> ElixirUUID.uuid3(:dns, "my.domain.com", :slug)
  ...
  ```elixir
  iex> ElixirUUID.uuid5(:dns, "my.domain.com")
  "016c25fd-70e0-56fe-9d1a-56e80fa20b82"

  iex> ElixirUUID.uuid5(:dns, "my.domain.com", :default)
  "016c25fd-70e0-56fe-9d1a-56e80fa20b82"

  iex> ElixirUUID.uuid5(:dns, "my.domain.com", :hex)
  "016c25fd70e056fe9d1a56e80fa20b82"

  iex> ElixirUUID.uuid5(:dns, "my.domain.com", :urn)
  "urn:uuid:016c25fd-70e0-56fe-9d1a-56e80fa20b82"

  iex> ElixirUUID.uuid5(:dns, "my.domain.com", :raw)
  <<1, 108, 37, 253, 112, 224, 86, 254, 157, 26, 86, 232, 15, 162, 11, 130>>

  iex> ElixirUUID.uuid5("fb49a0ec-d60c-4d20-9264-3b4cfe272106", "my.domain.com")
  "822cab19-df58-5eb4-98b5-c96c15c76d32"

  iex> ElixirUUID.uuid5("fb49a0ec-d60c-4d20-9264-3b4cfe272106", "my.domain.com", :slug)
  ...
  # Format the given hash as a ElixirUUID.
